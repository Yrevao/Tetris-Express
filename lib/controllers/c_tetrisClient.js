...
module.exports = {
    ...
    endMatch: (req, res, io) => {
        ...
        s_player.findManyByPropertyAndUpdate('match', req.body.match, 'board', []);
        s_player.findManyByPropertyAndUpdate('match', req.body.match, 'lost', false);
        s_player.findManyByPropertyAndUpdate('match', req.body.match, 'bagCount', 0);

        io.to(req.body.match).emit('reset');
        res.json({status: 'ok'});
