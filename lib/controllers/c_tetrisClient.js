...
module.exports = {
    ...
    updateState: (req, res, io) => {
        ...
        s_player.findByKeyAndUpdate(playerId, 'lost', req.body.lost);

        io.to(matchId).emit('update', {flag: 'update', player: playerId, board: player.board, lost: req.body.lost});
    ...
    joinSocket: (socket, io) => {
        ...
        const players = utils.reprop(playerData, ['board']);
